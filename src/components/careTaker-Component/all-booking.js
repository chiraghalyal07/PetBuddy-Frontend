    ...
    <Container>
      ...
      {displayedBookings.map((booking) => (
        <Paper key={booking._id} style={{ padding: 20, marginBottom: 20 }}>
          ...
          <Typography variant="body1"><strong>Total Amount:</strong> ₹{booking.totalAmount}</Typography>
          <Typography variant="body1"><strong>Booking Duration:</strong> {booking.bookingDurationInHours} hours</Typography>
      ...
      {selectedBooking && (
        <div>
          <Paper style={{ padding: 20, marginTop: 20, position: 'relative' }}>
            ...
            <Typography variant="body1"><strong>Total Amount:</strong> ₹{selectedBooking.totalAmount}</Typography>
            <Typography variant="body1"><strong>Booking Duration:</strong> {selectedBooking.bookingDurationInHours} hours</Typography>
            <Typography variant="body1"><strong>Status:</strong> {selectedBooking.status}</Typography>
            <Button variant="contained" color="success" style={{ marginTop: 10 }}>Accept Booking</Button>
            <Button variant="contained" color="error" style={{ marginTop: 10, marginLeft: 10 }}>Reject Booking</Button>
